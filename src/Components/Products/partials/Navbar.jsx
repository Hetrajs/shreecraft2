        ...
        <div className="relative mx-auto max-w-full px-6 lg:max-w-5xl xl:max-w-7xl 2xl:max-w-[96rem]">
          ...
          >
            ...
            <a
              ...
              href="/"
            >
              <img className=' object-cover' src="https://dl.dropboxusercontent.com/scl/fi/nvp6v4iavdkrcal9cprxi/Product-and-Cart-Logo.png?rlkey=3do18vgh5gsx8sz97ppmuea42&st=g03pvxag&dl=0" width={45} />
            </a>
            {/*      <!-- Mobile trigger --> */}
            <button
              ...
              <div className="lg:flex gap-2 items-center size-7">
                <Link to="/products/cart">
                  ...
                  {getTotalUniqueItems() > 0 && (
                    <span className="bg-red-500 text-white rounded-full absolute top-1 right-20 lg:top-2 lg:right-2 px-2 py-1 text-xs">
                      {getTotalUniqueItems()}
                    </span>
                  )}
                </Link>
